...
import self from "../assets/Atul.png";
...
export default function About({scrollToSection}) {
  return (
    <section
      id="about"
      className="about min-h-screen w-full flex items-center justify-center relative bg-black text-white overflow-hidden"
      aria-label="About me"
    >
      ...
      <div className="relative z-10 max-w-6xl w-full mx-auto px-6 md:px-10 lg:px-12 py-20 flex flex-col gap-12">
        ...
        >
          {/* Avatar / Card */}
          <motion.div
            className="relative w-40 h-40 md:w-50 md:h-50 rounded-full overflow-hidden shadow-2xl bg-linear-to-br from-[#1CD8D2]/20 to-[#302b63]/20 border border-[#1CD8D2]/25"
          ...
          <div className="flex-1 flex flex-col justify-center text-center md:text-left">
            ...
            <p className="mt-4 text-gray-300 leading-relaxed text-base sm:text-lg max-w-2xl md:max-w-3xl">
              I am a passionate fresher focused on building modern and reliable web applications. My toolkit includes the MERN stack (MongoDB, Express.js, React.js, Node.js), Tailwind CSS, and MySQL, with an emphasis on clean code, performance, and smooth user experiences.
            </p>
            ...
            <div className="mt-6 grid grid-cols-2 sm:grid-cols-3 gap-3 sm:gap-4 max-w-xl">
              {[
                ...
                { label: "Specialty", value: "Full Stack Web Development" },
        ...
        <div className="grid md:grid-cols-1">
          ...
          >
            ...
            <p className="text-gray-300 leading-relaxed text-base sm:text-lg">
             I am a dedicated Software Developer and a recent BCA graduate from Govt. Holkar Science College. Currently, I am sharpening my craft as a Trainee at InfoBeans Foundation, where I am building full-stack applications using Java, Spring Boot, and React.js.
            </p>
